...
resourcename="eventmanagementwebapp"  # lower case, only
resourcegroup="eventmanagementwebapp_rg"
...
# git clone https://github.com/apilogicserver/eventmanagementwebapp.git
...
az group create --name eventmanagementwebapp_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group eventmanagementwebapp_rg --sku S1 --is-linux
az container create --resource-group eventmanagementwebapp_rg --name eventmanagementwebapp --image apilogicserver/eventmanagementwebapp:latest --dns-name-label eventmanagementwebapp --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//eventmanagementwebapp.westus.azurecontainer.io:5656'
